...
public interface ReturnsAdapter {
    ...
    public ResponseEntity<ReturnsDTO> createReturns(
            @Valid @RequestBody ReturnsRequestDTO returnsRequestDTO);
    ...
    public ReturnsDTO getReturnsByReturnsReasonId(
            @PathVariable Long ReturnReasonId);

    @GetMapping("/api/returns/order/{orderId}")
    public ReturnsDTO getReturnsByOrderId(
            @PathVariable Long orderId);

    @GetMapping("/api/returns/member/{memberId}")
    public ReturnsDTO getReturnsByMemberId(
            @PathVariable String memberId);

    @PutMapping("/api/returns/order/{orderId}")
    public ResponseEntity<ReturnsDTO> updateReturns(
            @PathVariable Long orderId,
            @Valid @RequestBody ReturnsRequestDTO returnsRequestDTO);
